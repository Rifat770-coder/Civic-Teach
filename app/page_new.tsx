  ...
  return (
    <div className="bg-[#FFFFFF]">
      ...
      <section className="bg-gradient-to-br from-[#1E3E2D] via-[#2A5A3F] to-[#1E3E2D] text-[#FFFFFF] relative overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute top-20 left-10 w-32 h-32 bg-[#00A859] rounded-full opacity-10 animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-[#00A859] rounded-full opacity-10 animate-pulse delay-1000"></div>
      </section>
      ...
      <section className="py-20 bg-[#F9F9F9] relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-[#FFFFFF] p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center border-l-4 border-[#00A859]">
              <div className="text-5xl font-black text-[#1E3E2D] mb-3">2,847</div>
              <div className="text-[#555555] font-semibold text-lg">Legal Cases Processed</div>
              <div className="text-[#00A859] text-sm font-bold mt-2">↑ 23% this quarter</div>
            </div>
            <div className="bg-[#FFFFFF] p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center border-l-4 border-[#00A859]">
              <div className="text-5xl font-black text-[#1E3E2D] mb-3">95%</div>
              <div className="text-[#555555] font-semibold text-lg">Compliance Score</div>
              <div className="text-[#00A859] text-sm font-bold mt-2">↑ 8% improvement</div>
            </div>
            <div className="bg-[#FFFFFF] p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center border-l-4 border-[#00A859]">
              <div className="text-5xl font-black text-[#1E3E2D] mb-3">₹47.2Cr</div>
              <div className="text-[#555555] font-semibold text-lg">Legal Funds Tracked</div>
              <div className="text-[#00A859] text-sm font-bold mt-2">100% transparent</div>
            </div>
            <div className="bg-[#FFFFFF] p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 text-center border-l-4 border-[#00A859]">
              <div className="text-5xl font-black text-[#1E3E2D] mb-3">156</div>
              <div className="text-[#555555] font-semibold text-lg">Cases Resolved</div>
              <div className="text-[#00A859] text-sm font-bold mt-2">↑ 15% faster resolution</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#FFFFFF]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-[#F9F9F9] p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 group border-2 border-transparent hover:border-[#00A859]">
              <div className="w-16 h-16 bg-[#00A859] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-[#F9F9F9] p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 group border-2 border-transparent hover:border-[#00A859]">
              <div className="w-16 h-16 bg-[#000000] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-[#FFFFFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-[#F9F9F9] p-10 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 group border-2 border-transparent hover:border-[#00A859]">
              <div className="w-16 h-16 bg-[#1E3E2D] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-[#FFFFFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
